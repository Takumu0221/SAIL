...
public class TimeDependent_Offering extends OfferingStrategy {
	 ...
	 * strategy.
	 */
	// 相手のモデルが指定されていなければtarget utilityに近い値を
	// 指定されていればOMSに従ってビッドを決定する
	@Override
	public BidDetails determineNextBid() {
		...
		if (opponentModel instanceof NoModel) {
			...
			nextBid = omStrategy.getBid(outcomespace, utilityGoal);  // OMStrategy.javaの通常クラス（getBid）を使用している
		}
		return nextBid;
	}
